...
return {
  ...
  highlights = function(scheme, config)
    ...
    return {
      ...
      ["@lsp.type.parameter"]                     = { fg = scheme.base.blue, italic = true },
      ["@lsp.type.property"]                      = { fg = scheme.base.red },
      ...
      ["@lsp.type.typeParameter"]                  = { fg = colors.lighten(scheme.base.cyan, 15), italic = true },
      ...
      ["@lsp.typemod.function.readonly"]          = { fg = scheme.base.green, bold = true },
      ["@lsp.typemod.keyword.async"]              = { link = "@keyword.coroutine" },
      ["@lsp.typemod.keyword.injected"]           = { link = "@keyword" },
      ["@lsp.typemod.macro.defaultLibrary"]       = { link = "@function.builtin" },
      ["@lsp.typemod.method.defaultLibrary"]      = { link = "@function.builtin" },
      ["@lsp.typemod.operator.injected"]          = { link = "@operator" },
      ["@lsp.typemod.property.readonly"]          = { fg = scheme.base.magenta },
